...
import BoExamUpdate from '../BoExamUpdate/BoExamUpdate';
...
const BoAdminSadab = () => {
    const [boClass , setBoClass]= useState({})
        ...
        const onSubmit = boClass =>{

            fetch('https://fierce-beach-78095.herokuapp.com/boadminsadab' ,{
                method: 'POST',
                headers: { 'Content-Type': 'application/json'},
                body: JSON.stringify(boClass),
    ...
    <span  style={{fontSize:'25px', fontWeight:'bold'}}>Botany Admin Panel</span>
</div>
    <div class="row mr-0">
