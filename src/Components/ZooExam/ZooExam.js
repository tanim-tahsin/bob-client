...
const ZooExam = () => {
   ...
   const [exam,setExam] = useState({})
    ...
    useEffect(() => {
        // setLoading(true);
        fetch(`https://fierce-beach-78095.herokuapp.com/zooexam/${id}`)
        .then(res => res.json())
...
console.log(exam);
    ...
    const onSubmit=(data)=>{
        console.log('tanim',exam , "data",data)
       const newdata = {
    ...
    <span className="text-danger"  style={{fontSize:'25px', fontWeight:'bold'}}>Zoology Update Panel</span>
</div>
    <div class="row mr-0">
